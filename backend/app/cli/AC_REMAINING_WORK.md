...
10. Small-terminal/resize behavior is now covered by the 80x24/120x30 Pilot tests above. `NO_COLOR`/`--no-color`/plain non-TTY behavior for the TUI specifically, and real human keyboard/visual verification at a physical terminal, remain outside what an automated test in this environment can prove.
